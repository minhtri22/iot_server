...
public class ThingsboardSecurityConfiguration {
    ...
    protected static final String[] NON_TOKEN_BASED_AUTH_ENTRY_POINTS = new String[]{"/api/user/**",
    ...
    protected JwtTokenAuthenticationProcessingFilter buildJwtTokenAuthenticationProcessingFilter() throws Exception {
        ...
        pathsToSkip.addAll(Arrays.asList("/api/user/**",
    "/api/customer/**",WS_ENTRY_POINT, TOKEN_REFRESH_ENTRY_POINT, FORM_BASED_LOGIN_ENTRY_POINT,
